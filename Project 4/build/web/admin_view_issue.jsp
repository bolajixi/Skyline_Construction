<%-- 
    Document   : adin_view_issue
    Created on : Dec 22, 2019, 7:15:39 PM
    Author     : Lenovo
--%>
...
<!--	  Beginning:  Surrounding container for project card-->
                ...
                <%
                                try {
                                    ...
                                    String Query = "SELECT COUNT(ch_check) FROM projects WHERE `ch_check` = 'Yes'";
                ...
                <div class="mdl-cell mdl-cell--12-col-desktop">
                        <div class="mdl-card__title" style="background-color: #333333; color: white;">
                                    <h4>"<%= rs.getString("COUNT(ch_check)")%>" projects with construction issues found</h4>
                        </div>
                </div>
                <%
                            }
              ...
              <div class="mdl-cell mdl-cell--11-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone ">
                    ...
                    <table class="mdl-data-table mdl-js-data-table mdl-data-table--selectable mdl-shadow--2dp projects-table">
                        ...
                        <tr>
                            ...
                            <th class="mdl-data-table__cell--non-numeric">Project Description</th>
                        ...
                        <tbody>
                            <%
                                try {
                                    Class.forName("com.mysql.jdbc.Driver").newInstance();
                                    Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/project_4", "root", "");
                                    String Query = "SELECT * FROM projects ORDER BY proj_id, title, user_id; ";
                                    PreparedStatement pm = conn.prepareStatement(Query);
                                    ResultSet rs = pm.executeQuery();
                        ...
                        <tr>
                            ...
                            <td class="mdl-data-table__cell--non-numeric"><%= rs.getString("proj_descr")%></td>
                            
                            <td class="mdl-data-table__cell--non-numeric"><%= rs.getString("ch_descr")%></td>
                            
                            <td class="mdl-data-table__cell--non-numeric">
                                <a href="admin_viewdetailedissue.jsp?u=<%= rs.getString("proj_id")%>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-orange" style="margin: 0 2px 0 0;">
